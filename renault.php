            ...
            <div class="summary-section">
                <div class="vehicle-summary">
                    ...
                    <div class="vehicle-details">
                        <img src="img/Renault-ZOE-PNG.jpg" alt="Vehicle" class="vehicle-image" width="80px">
                        <div>
                            <p><strong>RENAULT ZOE</strong></p>
                            <p>Or French Dog</p>
                            <p>⚡ Hybrid</p>
                        </div>
                    </div>
                    <p><strong>€320.49</strong> (for 8 days)</p>
                    <p>Pick up: Diez Germany (2024-12-28, 10:00)</p>
                    <p>Return: Diez Germany (2025-01-6, 10:15)</p>
                </div>
                <div class="pricing-summary">
                    <p><strong>Protections & Extras</strong>: €0.00</p>
                    <p><strong>Total</strong>: €320.49</p>
